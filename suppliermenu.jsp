      ...
      <nav>
        <ul class="sf-menu">
          <li class="current"><a href="index.html">home</a></li>
           <li> <a href="editsupplier.jsp">Profile</a>
            <li> <a href="viewfertilizer.jsp">View Fertilizer</a>
           <li> <a href="viewcrop.jsp">View Crops</a>
           <li> <a href="viewmachine.jsp">View Machine</a>
            <li> <a href="import.jsp">Import</a>
           <li> <a href="export.jsp">Export</a>
           <li> <a href="Supplier.jsp">Logout</a>
          ...
          <div class="wrapper">
            <div class="grid_16 suffix_1 prefix_1 alpha">
              <article class="indent-bot">
                ...
                <div class="wrapper hr-border-1">
                  ...
                  <div class="grid_4"> <img src="images/machines.jpg" class="img-indent-bot" alt="">
                    <dl class="def-list-1">
                      <dt> <a href="#">Machines</a> </dt>
                    </dl>
                  </div>
            ...
            <div class="grid_5 suffix_1 omega">
              <article class="indent-bot-1">
                ...
                <p class="p1"> <strong> Indian Agronomy is one of Free website created by Maxgen team. </strong> </p></article>
                <!-- <p class="hr-border-1"> This website template is optimized for 1280X1024 screen resolution. It is also XHTML &amp; CSS valid. The PSD source files of this AgroPlus template are available for free for the registered members of TemplateMonster.com. Feel free to get them! </p>
                <div class="alignright"> <a href="#" class="button">Read more</a> </div> -->
