								...
								<div class="col-md-8">
										<div class="form-group">
											<label>Name:</label> <input type="text" 
												...
												placeholder="sname" value="${s.sname}" readonly="readonly">
										</div>
									</div>
									...
									<div class="col-md-8">
										<div class="form-group">
											<label>Email:</label> <input type="text" 
												...
												placeholder="s@gmail.com" value="${s.semail}" readonly="readonly">
										</div>
									</div>
										...
										<div class="form-group">
											<label>Password:</label> <input type="text" 
												...
												placeholder="******" value="${f.fpassword}" readonly="readonly">
										</div>
									</div>
									<div class="col-md-8">
										<div class="form-group">
											<label>Password:</label> <input type="text" 
												...
												placeholder="******" value="${s.sconfirmpassword}" readonly="readonly">
										</div>
									</div>
									...
									<div class="col-md-8">
										<div class="form-group">
											<label>Gender:</label> <input type="text" 
												...
												placeholder="male" value="${s.sgender}" readonly="readonly">
										</div>
										...
										<div class="form-group">
											<label>Country:</label> <input type="text" 
												...
												placeholder="2546879525" value="${s.sphone}" readonly="readonly">
										</div>
									</div>
										...
										<div class="form-group">
											<label>Country:</label> <input type="text" 
												...
												placeholder="company" value="${s.scompany}" readonly="readonly">
										</div>
									</div>
